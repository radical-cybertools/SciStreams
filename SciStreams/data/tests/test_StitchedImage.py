...
def test_stitched_image():
    ''' This tests the often used StitchedImage object.
        ...
        Note : Some of the behaviour is arbitrary. If it changes,
            ...
            Some possible cases:
            * stitching two images could result in a new image 1 pixel wider than
            previously. Depending on fringe cases that will come up, this might
            be something desirable etc.
