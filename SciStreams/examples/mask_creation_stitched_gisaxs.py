...
#hdrs = list(cmsdb(sample_name="AgBH_Julien",start_time=start_time, stop_time=stop_time))
hdrs_GISAXS = list(cmsdb(sample_name="Julien_beamstop_GISAXS_2", start_time=start_time, stop_time=stop_time))
