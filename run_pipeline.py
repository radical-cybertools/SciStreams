...
re_time_pairs = [
    ...
    (re.compile("^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$"), "%Y-%d-%m %H:%M"),
    (re.compile("^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$"), "%Y-%d-%m %H:%M:%S"),
]
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t0', '--start_time', dest='start_time', type=str,
                       help="The start time for the pipeline (default is 24 hrs prior to now)")
